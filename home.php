                ...
                <div id="imageCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="<?php echo $site_url; ?>images/banner-1.png?v=<?php echo date('H'); ?>" class="d-block w-100 mx-auto img-fluid hero_img" alt="3D CAD Jewelry 1">
                        </div>
                        <div class="carousel-item">
                            <img loading="lazy" src="<?php echo $site_url; ?>images/banner-2.png?v=<?php echo date('H'); ?>" class="d-block w-100 mx-auto img-fluid hero_img" alt="3D CAD Jewelry 2">
                        </div>
                        <div class="carousel-item">
                            <img loading="lazy" src="<?php echo $site_url; ?>images/banner-3.png?v=<?php echo date('H'); ?>" class="d-block w-100 mx-auto img-fluid hero_img" alt="3D CAD Jewelry 3">
                        </div>
                    </div>
