...
function sendMessage() {
    ...
    if (subject==''){
        ...
        alert_js('Please Select the user','Alert');
        $('#touser').focus();
        return false;
    }else if (message==''){
...
function add_reply(id) {
    // Set the data-id attribute of the reply button
...
function reply_message() {
    var element = document.getElementById('replyButton');
