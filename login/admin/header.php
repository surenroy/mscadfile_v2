...
<head>
    ...
    <link href="<?php echo $site_url; ?>login/admin/css/style.css?v=<?php echo $ver; ?>" rel="stylesheet">
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
            <ul class="navbar-nav flex-grow-0 me-auto mb-0">
                ...
                <li class="nav-item"><a class="nav-link text-white fw-bold px-2 py-1" href="<?php echo $site_url; ?>login/admin/index.php">Dashboard</a></li>
                <li class="nav-item"><a class="nav-link text-white fw-bold px-2 py-1" href="<?php echo $site_url; ?>login/admin/product.php">Product</a></li>
                <li class="nav-item"><a class="nav-link text-white fw-bold px-2 py-1" href="<?php echo $site_url; ?>login/admin/message.php">Message</a></li>

                <li class="nav-item"><a class="nav-link text-white fw-bold px-2 py-1" href="<?php echo $site_url; ?>login/admin/job.php">Jobs</a></li>
                <li class="nav-item"><a class="nav-link text-white fw-bold px-2 py-1" href="<?php echo $site_url; ?>login/admin/profile.php">Profile</a></li>


                <li class="nav-item"><a class="nav-link text-white fw-bold px-2 py-1" href="<?php echo $site_url; ?>login/admin/users.php">Users</a></li>
                <li class="nav-item"><a class="nav-link text-white fw-bold px-2 py-1" href="<?php echo $site_url; ?>login/admin/blog.php">Blog</a></li>
                <li class="nav-item"><a class="nav-link text-white fw-bold px-2 py-1" href="<?php echo $site_url; ?>login/admin/sells.php">Sell</a></li>
                <li class="nav-item"><a class="nav-link text-white fw-bold px-2 py-1" href="<?php echo $site_url; ?>login/admin/category.php">Category</a></li>
