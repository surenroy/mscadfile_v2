...
<nav class="navbar navbar-dark shadow-lg position-fixed bottom-0 w-100 d-lg-none"
    ...
    <div class="container d-flex justify-content-around position-relative">
        ...
        <a href="<?php echo $site_url; ?>login/user/product.php" class="nav-link text-white text-center">
            <i class="fa-solid fa-gem fa-lg"></i>
            <div style="font-size: 12px;">Product</div>
        </a>

        <a href="<?php echo $site_url; ?>login/user/message.php" class="nav-link text-white text-center">
            <i class="fa-solid fa-message fa-lg"></i>
            <div style="font-size: 12px;">Message</div>
        </a>

        <a href="<?php echo $site_url; ?>login/user/order.php" class="nav-link text-white text-center">
            <i class="fa-solid fa-microchip fa-lg"></i>
            <div style="font-size: 12px;">Order</div>
        </a>

        <a href="<?php echo $site_url; ?>login/user/sell.php" class="nav-link text-white text-center">
            <i class="fa-solid fa-coins fa-lg"></i>
            <div style="font-size: 12px;">Sell</div>
        </a>

        <a href="<?php echo $site_url; ?>login/user/job.php" class="nav-link text-white text-center">
